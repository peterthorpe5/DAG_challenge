...
QUESTION TO THE REASEARCH TEAM: These temperatures seem a little high for Antartica. Is the equipment callibrated correctly?



## SUMMARY colB

This is a poisson distribution. These are discreet counts of observations per time point.It could be number of animals seen. ColA and ColB have a 0.11 corrolation, thus they are not corrolated.  

I am presuming this is data from a weather station. So more likely to be ... a discete variable form a weather station?

QUESTION TO THE REASEARCH TEAM: what are you counting here?
